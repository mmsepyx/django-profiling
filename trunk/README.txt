How to Install Django-profiling:
...
Add "profiling" to the INSTALLED_APPS section of your settings.py file


Step 4:

Add this to the end of your MIDDLEWARE_CLASSES section of your settings.py file
